...
public class NetworkWriter
{
    ...
    // "int" - лучший тип дл€ .ѕозици€. "short" слишком мал, если мы отправим > 32kb, что приведет к отрицательному результату .ѕозици€
    // - >преобразование long в int нормально до 2GB данных (MAX_INT), поэтому нам не нужно беспокоитьс€ о переполнени€х
    ...
    // MemoryStream имеет 3 значени€: положение, длина и емкость.
    // Position используетс€ дл€ указани€ того, где мы пишем
    // Length - сколько данных мы написали
    // capacity - это объем выделенной пам€ти
    // ToArray возвращает все данные, которые мы написали, независимо от текущей позиции
    public byte[] ToArray()
    {
        writer.Flush();
